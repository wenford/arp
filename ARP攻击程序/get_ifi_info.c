...
get_ifi_info(int family, int doaliases)
{
	...
	char				*ptr, *buf, lastname[IFNAMSIZ], *cptr,*sdlname=NULL;
	unsigned char		haddr[IFI_HADDR]; 
	struct ifconf		ifc;
...
//             struct sockaddr_ll  *sdl = (struct sockaddr_ll *) &ifrcopy.ifr_addr;
//              idx = sdl->sll_ifindex;
//		hatype=sdl->sll_hatype;
              memcpy(haddr, ifrcopy.ifr_hwaddr.sa_data, IFI_HADDR);
              hlen = 6;
